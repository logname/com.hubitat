...
class HubitatElevationApp extends Homey.App {
  ...
  mapDeviceToDriver(hubitatDevice) {
    ...
    if (capabilities.includes('GarageDoorControl')) {
      compatibleDrivers.push('garage-door');
    }
    ...
    // Air Quality Sensor - check for any air quality related capabilities
    if (capabilities.includes('AirQuality') || capabilities.includes('CarbonDioxideMeasurement') ||
        capabilities.includes('Pm25') || capabilities.includes('Pm10') || capabilities.includes('Tvoc')) {
      compatibleDrivers.push('air-quality');
    }
